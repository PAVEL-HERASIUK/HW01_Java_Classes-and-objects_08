...
public class Train {
	...
	public String toString() {
		return "Train [destinationStation=" + destinationStation + ", numberTrain=" + numberTrain + ", departureHours="
				+ departureHours + ", departureMinutes=" + departureMinutes + "]";
	}
}
